...
\coordinate (start-particle) at (0.5in, 4in);
\coordinate (start-mesh) at (1in, 4in);

\node[oncpu, particle] (init-pstate) at (0.5in, 2in) {};
\node[oncpu, mesh] (init-mstate) at (1in, 3in) {};

\node[ongpu, particle] (gpu-init-pstate) at (4.5in, 2in) {};
\node[ongpu, mesh] (gpu-init-mstate) at (5in, 3in) {};
...
\path[function] (start-particle) -- (init-pstate) node[functionbox, pos=0.5] {Load \\ Particles};

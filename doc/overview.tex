...
\tikzstyle{copy}=[draw=black,dashed]
\tikzstyle{function}=[draw=black,dotted]
...
\path[copy,-{Stealth[scale=3]}] (init-pstate) -- (gpu-init-pstate);
\path[copy,-{Stealth[scale=3]}] (init-mstate) -- (gpu-init-mstate);
\end{tikzpicture}

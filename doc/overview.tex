...
For subsequent sortings, we use coherence, which means that particles most often will stay within the same element or move at most one element away during a timestep.
